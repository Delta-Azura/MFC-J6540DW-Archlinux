...
#
_model=mfcj6540dw
_device_name=MFC-J6540DW
pkgname=brother-mfc-j6540dw
pkgver=3.5.0
pkgrel=1
...
license=("EULA")
source=("https://download.brother.com/welcome/dlf105476/mfcj6540dwpdrv-3.5.0-1.i386.rpm")
md5sums=('5c5c2e83a8d70b9b4c190300b879c29c')
depends=('perl' 'cups')
